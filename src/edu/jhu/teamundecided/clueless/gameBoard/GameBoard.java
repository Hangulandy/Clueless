...
public class GameBoard
{
	...
	public GameBoard()
    {
        ...
        billiard_room = new Room("billiard_room");
        dining_room = new Room("dining_room");
        conservatory = new Room("conservatory");
        ballroom = new Room("ballroom");
        kitchen = new Room("kitchen");
        hallway_1 = new Room("hallway_1");
        hallway_2 = new Room("hallway_2");
        hallway_3 = new Room("hallway_3");
        hallway_4 = new Room("hallway_4");
        hallway_5 = new Room("hallway_5");
        hallway_6 = new Room("hallway_6");
        hallway_7 = new Room("hallway_7");
        hallway_8 = new Room("hallway_8");
        hallway_9 = new Room("hallway_9");
        hallway_10 = new Room("hallway_10");
        hallway_11 = new Room("hallway_11");
        hallway_12 = new Room("hallway_12");
